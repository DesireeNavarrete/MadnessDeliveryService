...
public class detector : MonoBehaviour
{
    ...
    public bool playerMesa, entregaTrg, paraCoger;
    public static bool playerPlato, playerObj, colBasura, datafono, cogido;
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.transform.tag == "cajaAma")
        {
            ...
            if (Input.GetButtonDown("Acction") || CrossPlatformInputManager.GetButtonDown("Acction") && !cogido && gameObject.transform.childCount == 0)
        ...
        if (other.transform.tag == "objetos")
        {
            ...
            //if (Input.GetButtonDown("Acction") && !cogido && paraCoger && playerMesa)
            if (Input.GetButtonDown("Acction") && !cogido && paraCoger && playerMesa && platosPlayer.Count == 0)
            //if (CrossPlatformInputManager.GetButtonDown("Acction") && !cogido && paraCoger && playerMesa && platosPlayer.Count==0)
            {
            ...
            //COGER DEL SUELO
            //if (Input.GetButtonDown("Acction") && !cogido && paraCoger && platosPlayer.Count==0 && objsPlayer.Count<2)
            //if (Input.GetButtonDown("Acction") && !cogido && paraCoger && objsPlayer.Count<2)
            if (Input.GetButtonDown("Acction") && !cogido && paraCoger)//va mejor que los demas
            //if (CrossPlatformInputManager.GetButtonDown("Acction") && !cogido && paraCoger)//va mejor que los demas
            {
            ...
            if (Input.GetButtonDown("Acction") && colBasura)
            {
                //if (CrossPlatformInputManager.GetButtonDown("Acction") && colBasura){
        ...
        if (other.transform.tag == "mesa")
        {
            ...
            /*if(hijo!="plato")
            {
                ...
                if (Input.GetButtonDown("Acction") && cogido && !paraCoger && gameObject.transform.parent != null)
                //if (CrossPlatformInputManager.GetButtonDown("Acction") && cogido && !paraCoger && gameObject.transform.parent != null)
                {
        ...
        if (other.transform.tag == "plato")
        {
            ...
            //if (Input.GetButtonDown("Acction") && !cogido && paraCoger && objetos.colPlato)
            //if (Input.GetButtonDown("Acction") && !cogido && paraCoger && platosPlayer.Count>=0 && objsPlayer.Count>=0)


            //coger plato+obj 
            if (Input.GetButtonDown("Acction") && !cogido && paraCoger && plato.colPlatos.Count > 0 && objsPlayer.Count > 0)
            //if (CrossPlatformInputManager.GetButtonDown("Acction") && !cogido && paraCoger && plato.colPlatos.Count>0 && objsPlayer.Count>0)
            {
            ...
            //coger plato 
            //if (Input.GetButtonDown("Acction") && !cogido && paraCoger && !objetos.colPlato)
            if (Input.GetButtonDown("Acction") && !cogido && paraCoger && objsPlayer.Count == 0)
            //if (CrossPlatformInputManager.GetButtonDown("Acction") && !cogido && paraCoger && objsPlayer.Count==0)
            {
                print("coge plato");
                other.transform.SetParent(gameObject.transform);
                other.GetComponent<Rigidbody>().isKinematic = true;
            ...
            //if (Input.GetButtonDown("Acction") && cogido && !paraCoger && playerPlato && !colBasura)
            if (Input.GetButtonDown("Acction") && cogido && !paraCoger && playerPlato && !colBasura)
            //if (CrossPlatformInputManager.GetButtonDown("Acction") && cogido && !paraCoger && playerPlato && !colBasura)
            {
                //print("suelo");
            ...
            //if (Input.GetButtonDown("Acction") && cogido && !paraCoger && playerPlato)
            if (Input.GetButtonDown("Acction") && cogido && !paraCoger && playerPlato)
            // if (CrossPlatformInputManager.GetButtonDown("Acction") && cogido && !paraCoger && playerPlato)
            {
        ...
        if (Input.GetButtonDown("Acction") && (other.transform.tag == "cajaA" || other.transform.tag == "cajaV" || other.transform.tag == "cajaR" || other.transform.tag == "mesa") && transform.Find("plato"))
        //if (CrossPlatformInputManager.GetButtonDown("Acction") && (other.transform.tag=="cajaA" || other.transform.tag == "cajaV" || other.transform.tag == "cajaR" || other.transform.tag == "mesa") && transform.Find("plato"))
        {
