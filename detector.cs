...
public class detector : MonoBehaviour
{
    ...
    public bool cogido, paraCoger, playerMesa, entregaTrg;
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.transform.tag == "mesa")
        {
            ...
            if(hijo=="objV" || hijo == "objR" || hijo == "objA")
            {
                playerObj = true;
        ...
        if (other.transform.tag == "plato")
        {
           ...
           if (Input.GetButtonDown("Submit") && !cogido && paraCoger && plato.colPlatos.Count>0)
           {
            ...
            if (Input.GetButtonDown("Submit") && cogido && !paraCoger && playerPlato)
            {
                ...
                if (transform.childCount > 0 && entregaTrg && platosPlayer.Count < 2)
                {
